...
const fr = {
  ...
  /* Messagerie PRIVÉE entre comptes — chiffrée de bout en bout, séparée du
     chat général d'une app (chat.* ci-dessus), qui n'est jamais privé. */
  'nav.messages': 'Messagerie',
  'messages.title': 'Messagerie',
  'messages.newMessage': 'Nouveau message',
  'messages.pickRecipient': 'Choisir un destinataire',
  'messages.noConversations': 'Aucune conversation. Démarres-en une.',
  'messages.noUsers': 'Aucun autre compte sur cette machine.',
  'messages.selectConversation': 'Sélectionne une conversation à gauche.',
  'messages.placeholder': 'Écris un message… (Entrée pour envoyer)',
  'messages.send': 'Envoyer',
  'messages.empty': 'Aucun message. Écris le premier.',
...
const en: Record<MessageKey, string> = {
  ...
  'messages.pickRecipient': 'Choose a recipient',
  'messages.noConversations': 'No conversations yet. Start one.',
  'messages.noUsers': 'No other account on this machine.',
  'messages.selectConversation': 'Select a conversation on the left.',
  'messages.placeholder': 'Write a message… (Enter to send)',
  'messages.send': 'Send',
  'messages.empty': 'No messages yet. Write the first one.',
